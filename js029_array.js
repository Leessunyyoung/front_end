...
// Tim Sort Insertion sort와 Merge Sort을 결합하여 만든 정렬이다
...
let xData = [1, 2, 3];
let yData = [4, 5, 6];
let zData = xData.concat(yData, [7, 8, 9]); //concat->합쳐준다
console.log(zData.length); //9
console.log(zData); //[ 1, 2, 3, 4, 5, 6 ,7,8,9]

let arr2 = [1, 3, [[[4, 5]]], [7, 8], [9, 10]];
console.log(arr2.flat()); //[ 1, 3, [ [ 4, 5 ] ], 7, 8, 9, 10 ]
console.log(arr2); //[ 1, 3, [ [ [Array] ] ], [ 7, 8 ], [ 9, 10 ] ]
console.log(arr2.flat(1)); //[ 1, 3, [ [ 4, 5 ] ], 7, 8, 9, 10 ]
console.log(arr2.flat(2)); //[ 1, 3, [ 4, 5 ], 7, 8, 9, 10 ]
console.log(arr2.flat(3)); //[1, 3, 4, 5,7, 8, 9, 10]
