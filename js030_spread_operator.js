...
///////////////////////////////
//[1] 배열에서의 Spread Operator =스프레드 연산자 =전개연산자
//=>펼침연산자
//형태 : (...q변수)
...
// arr10[4]= 15;
// console.log(arr11);//[ 1, 2, 3, 4, 5, 6, 7, 8, 9, <1 empty item>, 15 ]
...
console.log(Math.max(...arr13)); //...arr13->[10,20,30,40,50]
//결과값 50

//////////////////////////////////////////////////
//[3] 객체에서 Spread Opeartor
...
prevState2.name = '박보검';
console.log(prevState2); //{ name: '박보검', age: 30 }
prevState2 = { ...prevState2, name: '박보검' };
console.log(prevState2); //{ name: '박보검', age: 30 }
