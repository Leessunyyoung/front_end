...
let m, n;
[n, m] = [c, d];
console.group(`n=${n} , m=${m}`); //n=5 , m=10
...
//fullname값을 fn에 저장 job값을 jb에 저장
...
console.log(completedHabit); // [{ id: 2, content: '걷기', completed: true },{ id: 3, content: '명상', completed: true }]
...
let { name2, address } = member;
let { city } = address;

console.log(`${name2} 고객님은 ${city}에 거주합니다 `);
